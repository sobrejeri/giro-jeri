...
// ⚠️ NÃO FUNCIONA. Mesmo endpoint (POST /v1/payments) e mesmo parâmetro que o
// Mercado Pago recusou em produção com cartão:
//
//     "The name of the following parameters is wrong : [disbursements]"
//
// Foi escrito para o motor de pernas (multi-recebedor) e nunca chegou a ser
// exercitado — está atrás de uma flag desligada. Fica documentado aqui para
// que ninguém ligue a flag esperando que funcione: o campo não é aceito.
